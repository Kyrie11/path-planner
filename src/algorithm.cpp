  ...
  while (!O.empty()) {
    ...
    // EXPANSION OF NODE
      ...
      // CONTINUE WITH SEARCH
        ...
        std::cout<<"nPred--- x:"<<nPred->getX()<<",y:"<<nPred->getY()<<",Idx:"<<nPred->getIdx()<<std::endl;
        ...
        for (int i = 0; i < dir; i++) {
          ...
          // std::cout<<"successor's x:"<<nSucc->getX()<<",y:"<<nSucc->getY()<<std::endl;
          //  if (nSucc->isOnGrid(width, height)) std::cout<<"the successor is on grid\n"; 
          // ensure successor is on grid and traversable
          // if(configurationSpace.isTraversable(nSucc)) std::cout<<"the successor is Traversable\n";
